    ...
    >
      ...
      <div className="projects-list">
        <Project
          ...
          description="In a team of five we developed a web tool to help master
          students choose courses which meet the degree requirements. The tool 
          was developed in .NET with C# and REACT.js and I worked mainly with 
          backend and the implementation of saving/updating profiles of chosen 
          courses. Look at the demo below."
        ...
        <Project
          ...
          description="In the course Communication and User Interfaces TNM040, me
        ...
        <Project
          ...
          description="In the course Modelling Project TNM085, together with three other
          students I developed a simplified version of the game Angry Birds. We calculated
          the bird's trajectory before and after collsion with an object, simulated it in Matlab
